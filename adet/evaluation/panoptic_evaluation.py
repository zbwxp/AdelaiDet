...
from detectron2.data.datasets.builtin_meta import _get_coco_panoptic_separated_meta

logger = logging.getLogger(__name__)


class COCOPanopticEvaluator_test(DatasetEvaluator):
    """
    ...
    def __init__(self, dataset_name, output_dir):
        ...
        self._metadata = MetadataCatalog.get('coco_2017_test-dev_panoptic_separated')
